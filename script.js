...
const cards = [blue1, blue2, blue3, blue4, blue5, blue6, blue7, blue8, blue9, blue10, blue11, blue12];
...
ordinary.addEventListener("click",() =>{
    const randomImg = Math.ceil(Math.random() * 2) -1;
    lol.src = cards[randomImg];
} )
